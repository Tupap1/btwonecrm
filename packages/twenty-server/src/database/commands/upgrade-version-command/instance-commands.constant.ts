...
import { AddFieldSalesTablesFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-19/2-19-instance-command-fast-1782926383842-add_field_sales_tables';
...
export const INSTANCE_COMMANDS = [
  ...
  AddFieldSalesTablesFastInstanceCommand,
];
